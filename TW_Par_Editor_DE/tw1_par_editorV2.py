#!/usr/bin/env python3
"""TW1 PAR Editor v1.2 — View, edit, and export Two Worlds 1 .par parameter files
...
class ParEditorApp:
    def __init__(self, root):
        self.root = root
        self.root.title("TW1 PAR Editor v1.2")
    ...
    def _update_title(self):
        ...
        self.root.title(f"TW1 PAR Editor v1.2 — {name}{mod}")
