...
- **1699 German tooltip descriptions** — hover over any field label to see what it does
...
| `tw1_sdk_descriptions.json` | 1699 German tooltips for field descriptions |
...
See [ANLEITUNG.md](ANLEITUNG.md) for a detailed German guide.
